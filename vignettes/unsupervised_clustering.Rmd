...
-   symptom_order: A vector of symptom names indicating the order to
    plot symptoms on the y-axis. This overrides cluster_rows. The
    default order if cluster_rows = FALSE and symptom_order = NULL is
    the order of the column names in the dataframe (minus the ID and
    community columns). (Default: NULL)
...
-   network: A network object output by construct_ggm. If a network is
    ...
    overrides the cluster_rows and symptom_order parameters. (Default:
    NULL)
